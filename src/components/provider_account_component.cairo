...
/// # Provider Account Component
///
/// The Provider account component enables contracts to behave as accounts. It is a implemented as a
/// component.
#[starknet::component]
pub mod ProviderAccountComponent {
